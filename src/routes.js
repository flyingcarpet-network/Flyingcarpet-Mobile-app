      ...
      >
        <Lightbox>
          <Scene key="Root" renderRightButton={<RightButton onPress={() => Actions.settingsLightbox()}><FontAwesome name={'cog'} size={28} /></RightButton>}>
            ...
            <Scene key="droneOwnerChannels" component={containers.DroneOwnerChannels} title="Drone Channels" {...sceneArguments} />
            ...
            <Scene key="channelDetails" component={containers.ChannelDetails} title="Connected Channel" {...sceneArguments} />
          </Scene>
          {/* Lightbox Scenes */}
