...
import { type Channel, type MapCoordinateCircle } from '../types';

type StateTypes = {
  newFlyingCarpetAttached: boolean, // True if a flyingcarpet was just attached in the attach dialog (only True
  ...
  flyingCarpetAddress: string, // This is the flyingcarpet's smart contract address that is scanned from the QR code
  // The following field is an array of location circle objects (lat, long, and radius) that represent the most ideal nearby locations for Flying Carpets.
  // NOTE: radius is measured in metres
  flyingCarpetBestLocations: Array<MapCoordinateCircle>,
  channelData: ?Channel // This represents the channel data of the currently selected channel
};
